...
typedef struct _AFEDATA_{
	...
	//UINT16 BFLAG;		//本来42个够了，但是因为时基问题，要分割，所以添加一个为44，要划分为4份了
}AFEDATA;
...
#define TWI_RD_CLK		(uint16_t)(GPIOB->IDR&GPIO_Pin_10)  //输入SDA 
#define TWI_RD_DAT		(uint16_t)(GPIOB->IDR&GPIO_Pin_11)  //输入SDA 
#endif
