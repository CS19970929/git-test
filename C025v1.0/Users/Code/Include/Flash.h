...
#define FLASH_ADDR_APP_START 			0x08001C00		//APP=64-7-6=51K


// #define FLASH_ADDR_SOC_RTC_CNT          0x0800EC00		//RTC次数统计，用于是否更新SOC

#define FLASH_ADDR_SH367309_VALUE 		0x0800F000		//休眠带电关键参数(电流偏置值)，1K
#define FLASH_ADDR_WAKE_TYPE 		    0x0800F400		//休眠是否带电标志位，1K
