...
void App_MosOtp_SecondCheck(void) {
    ...
    if(1 == g_st_SysTimeFlag.bits.b1Sys10msFlag5) {
        ...
        t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
        t_sPubOPUPChk.u16TimeCntB = PRT_E2ROMParas.u16TmosOTp_Filter*2;           //¹ÊÕÏÅĞ¶ÏÊ±¼ä500ms
        t_sPubOPUPChk.u16TimeCntS = PRT_E2ROMParas.u16TmosOTp_Filter*2;           //¹ÊÕÏ»Ö¸´ÅĞ¶ÏÊ±¼ä500ms
        t_sPubOPUPChk.u8FlagLogic = 1;                                          //ÕıÂß¼­
